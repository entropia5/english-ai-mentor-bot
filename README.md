...
| --- | --- |
| ![Главное меню English AI Mentor](docs/ui/main-menu.jpg) | ![Экран выбора темы для новых слов](docs/ui/new-words-menu.jpg) |

| Словарь | Выученные слова |
| --- | --- |
| ![Страница словаря с новыми словами](docs/ui/dictionary-page.jpg) | ![Страница выученных слов](docs/ui/learned-words.jpg) |

| Режим AI | Статистика |
| --- | --- |
| ![Экран режима AI](docs/ui/ai-mode.jpg) | ![Экран статистики прогресса](docs/ui/stats.jpg) |
...
После утренней и вечерней рассылки бот отправляет короткое текстовое сообщение под экраном. Оно удаляется автоматически через 15 минут или сразу после нажатия любой inline-кнопки.
